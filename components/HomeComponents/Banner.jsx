          ...
          <div className="flex items-center md:items-center md:justify-around">
                  ...
                  <span>
                    ...
                    <span className="text-Snow sm:text-xl xl:text-2xl font-bold">
                      ...
                      <span className="inline-block">
                        <Typewriter
                          options={{
                            strings: ["a MERN Stack Developer", "Vikas Tiwari"],
                            autoStart: true,
                            loop: true,
                          }}
                        />
            ...
            <div className="w-48 h-52 relative hidden md:block">
              <Image
                ...
                layout="responsive" // Adjust this according to your image aspect ratio
                className=" absolute top-8 w-full h-full" // You can keep your existing classes here
              />
            </div>
          </div>
        </div>
